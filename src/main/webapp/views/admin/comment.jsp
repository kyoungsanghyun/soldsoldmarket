...
<style>
    ...
    #ulTable > li > ul > li:first-child +li+li        {width:15%;} /*게시글명 열 크기*/
    #ulTable > li > ul > li:first-child +li+li+li     {width:40%;} /*댓글내용 열 크기*/
    #ulTable > li > ul > li:first-child +li+li+li+li  {width:15%;} /*작성일 열 크기*/
