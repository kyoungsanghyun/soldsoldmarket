	...
	<div class="write">
		<form name = "productRegist" action="${ path }/product/update" method="POST" enctype="multipart/form-data">
			...
			<div class="information">
				...
				<!-- 기존 파일 이름 -->
				<input type="hidden" name="imgpre1" id="imgpre1" value="${padd.PAimg1}">
				<input type="hidden" name="imgpre2" id="imgpre2" value="${padd.PAimg2}">
				<input type="hidden" name="imgpre3" id="imgpre3" value="${padd.PAimg3}">
		        <input type="hidden" name="imgpre4" id="imgpre4" value="${padd.PAimg4}">
		      	<input type="hidden" name="imgpre5" id="imgpre5" value="${padd.PAimg5}">
				<!-- 여기까지 숨겨진 값 -->
			...
			<div class="board-write-box">
				...
				<span><b>상품 상태</b></span>
				<br><br>
				<input type="radio" name="condition" value="개봉" <c:if test ="${product.PQlt eq '개봉'}">checked="checked"</c:if>> 개봉
				<input type="radio" name="condition" value="거의새것" <c:if test ="${product.PQlt eq '거의새것'}">checked="checked"</c:if>>거의 새것
				<input type="radio" name="condition" value="사용감있음" <c:if test ="${product.PQlt eq '사용감있음'}">checked="checked"</c:if>>사용감 있음
				<hr style="width:90%; margin: 20px 0 0 5%;">
				<br>
				<span><b>거래지역 *</b></span>
				<br><br>
				<input type="text" name="location" id="location" value="${ product.PLocation }" required>
				<hr style="width:90%; margin: 20px 0 0 5%;">     
				<br>    
				<span><b>교환 *</b></span>
				<br><br>
